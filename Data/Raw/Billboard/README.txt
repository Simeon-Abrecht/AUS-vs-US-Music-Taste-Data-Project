...
The following datasets were constructed via the chatGPT prompt: "Convert the table from {insert webpage} in to a downloadable csv file". As such they do not possess the same spotify API information as the Kaggle dataset. This will be rectified in the silver layer:
